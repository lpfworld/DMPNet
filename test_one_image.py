...
from modeling.DMPNet import DenseScaleNet as DMPNet
...
def img_test(pretrained_model, img_path='/home/lpf/PycharmProjects/DMPNet/TestImages/shanghaiB/IMG_26.jpg'):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/home/lpf/PycharmProjects/DMPNet/models/best_model.pth',metavar='model path', type=str)
    parser.add_argument('--test_img_path', default='/home/lpf/PycharmProjects/DMPNet/TestImages/shanghaiB/IMG_26.jpg', metavar='test image path', type=str)
